...
${DATA_VALID_EMAIL}     elsa.sarah25@yahoo.com
${DATA_INVALID_EMAIL}   elsa.sarah25
${DATA_EXT_EMAIL}       @yahoo.com
${DATA_DISCOUNT}        HEMAT20
${DATA_NAME}            Harry Park
${DATA_PHONE}           +442912345678
${DATA_ADDRESS}         221b Baker Street
${DATA_CITY}            London
${DATA_NOTE}            please pack it well
...
TC09. Verify if the user can input invalid promo coupon
    ...
    input text                  ${PROMOCOUPON2}             ${DATA_DISCOUNT}
...
TC10. Verify if the user can input an email without a valid email extension behind it
    ...
    click button                ${BUTTON_GOTOBAG}
    sleep                       3
    input text                  ${EMAIL}                    ${DATA_INVALID_EMAIL}
...
TC11. Verify if the user can input the extension of the email without an email name
    ...
    select from list by value   ${QUANTITY3}                3
    sleep                       3
    input text                  ${EMAIL}                    ${DATA_EXT_EMAIL}
    click button                ${BUTTON_CHECKOUT}
    element should be visible   ${NOTIF4}
...
TC12. Verify if the user can input an valid email address
    ...
    click button                ${BUTTON_ADDTOBAG}
    click button                ${BUTTON_GOTOBAG}
    input text                  ${EMAIL}                    ${DATA_VALID_EMAIL}
    click button                ${BUTTON_CHECKOUT}
...
TC13. Verify if the user can input a valid data for shipping address and choose the shipping method
    ...
    click button                ${BUTTON_CHECKOUT}
    sleep                       5
    input text                  ${INPUT_NAME}               ${DATA_NAME}
    input text                  ${INPUT_PHONE}              ${DATA_PHONE}
    input text                  ${INPUT_ADDRESS}            ${DATA_ADDRESS}
    input text                  ${INPUT_CITY}               ${DATA_CITY}
...
TC14. Test payment is done successfully by choosing Cash on Delivery payment method
    ...
    input text                         ${INPUT_NOTE}               ${DATA_NOTE}
